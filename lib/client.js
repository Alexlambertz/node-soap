...
Client.prototype._defineMethod = function(method, location) {
  var self = this;
  var temp;
  return function(args, callback, options, extraHeaders, attachments) {
    ...
    self._invoke(method, args, location, attachments, function(error, result, raw, soapHeader, files) {
      callback(error, result, raw, soapHeader, files);
    }, options, extraHeaders);
  };
};

Client.prototype._invoke = function(method, args, location, attachments, callback, options, extraHeaders) {
  var self = this,
    name = method.$name,
    input = method.input,
  ...
  }, attachments, headers, options, self);
