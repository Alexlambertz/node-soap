...
HttpClient.prototype.request = function(rurl, data, callback, attachments, exheaders, exoptions) {
  var self = this;
  ...
  var form = new formidable.IncomingForm({maxFieldsSize: 1000 * 1024 * 1024});

  form.uploadDir = "../uploads2/";
